...
import { searchNC, exportNcPDF, exportNcExcel,
         exportRapportMensuel, getExportStats }
  from '../controllers/exportController.js';

const router = Router();
router.use(verifyToken);

router.get('/nc',              searchNC);
router.get('/nc/excel',        requireRole('rq','admin','responsable_service'), exportNcExcel);
router.get('/nc/:id/pdf',      exportNcPDF);
router.get('/rapport-mensuel', requireRole('rq','admin'), exportRapportMensuel);
router.get('/stats',           requireRole('rq','admin','direction'), getExportStats);
